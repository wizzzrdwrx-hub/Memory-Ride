...
export const memoryPins: MemoryPin[] = [
  {
    ...
    text: "Packing up the station wagon under the heavy Charleston heat. The air conditioning was already broken, but we didn't care—the windows were down, the sea breeze was waiting, and a week of absolute freedom was just down the road.",
  ...
  },
  {
    ...
    text: "Cruising high over the James Island Expressway. Looking out across the sparkling harbor, watching the historic skyline shrink in the rearview mirror as the marshlands opened up. That first real glimpse of pluff mud and tidal creeks meant the beach was finally real.",
  ...
  },
  {
    ...
    text: "The mandatory roadside ritual. Dad always pulled the station wagon onto the gravel lot to buy a bag of fresh shrimp directly from the docks. The heavy coastal air hit us immediately—a mix of salt, diesel, melting ice, and pluff mud.",
  ...
  },
  {
    ...
    text: "The engine finally cuts off under the shade of the beach cottage. We scrambled out onto the warm wooden stairs, smelling the salt spray and hearing the steady rumble of the Atlantic surf just behind the dunes. We were finally home.",
